...
def fit_ridge(train_features, train_y, valid_features, valid_y, train_mask, valid_mask, MAX_SAMPLES=100000):
    # If the training set is too large, subsample MAX_SAMPLES examples
    ...
    return lr, min(valid_results), best_alpha
